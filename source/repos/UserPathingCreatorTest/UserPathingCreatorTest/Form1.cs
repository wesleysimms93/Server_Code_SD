...
namespace UserPathingCreatorTest
{
    public partial class Form1 : Form
    {
        ...
        private void load_file_button_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                ...
                foreach (string line in lines.Skip(1))
                {
                    ...
                    {
                        pathPoints.Add(new PathPoint { X = x, Y = y, Action = parts[2] });
                    }
                }
                pathingCanvas.Invalidate();
            }
        ...
        {
            MessageBox.Show("New File button clicked!");

            string filePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), "NewFile.txt");
            try
            {
            ...
            {
                MessageBox.Show("Failed to create or open file: " + ex.Message);
            }
        }
